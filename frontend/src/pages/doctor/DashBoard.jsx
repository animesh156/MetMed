  ...
  return (
    <div className="flex h-screen overflow-hidden">
      ...
      <div className="flex-1 overflow-y-auto p-6 bg-gray-50">
        <h1 className="text-3xl font-bold text-center mb-2">Doctor Dashboard</h1>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 justify-center">
          ...
          <div className="card bg-white p-5 rounded shadow hover:shadow-md transition">
            <h2 className="text-xl font-semibold mb-3">Consultation History</h2>
          ...
          <div className="card bg-white p-5 rounded shadow hover:shadow-md transition">
            ...
            <button className="btn btn-warning">Update Slots</button>
          </div>

          <div className="card bg-white p-5 rounded shadow hover:shadow-md transition">
            <h2 className="text-xl font-semibold mb-3">My Earnings</h2>
            <p className="text-gray-700 mb-3">₹84,000 earned this month</p>
            <button className="btn btn-neutral">View Reports</button>
          </div>
        </div>
      </div>
    </div>
